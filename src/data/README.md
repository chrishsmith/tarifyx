...
| File | Size | Purpose |
|------|------|---------|
| `crossRulings.json` | 20 MB | 16,978 CBP CROSS rulings |
| `crossRulingsEmbedded.json` | 549 MB | Rulings with vector embeddings |
| `hsCodeComp.json` | 1.7 MB | 632 e-commerce test records |

## How to Download

### 1. Download CROSS Rulings
```bash
npx ts-node scripts/ingest-cross-rulings.ts
```
