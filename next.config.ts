        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://api.maptiler.com https://*.sentry.io",
              "font-src 'self' data:",
              "connect-src 'self' https://api.maptiler.com https://*.sentry.io https://*.ingest.sentry.io https://dataweb.usitc.gov https://hts.usitc.gov https://api.federalregister.gov",
